 ...
 //string plaintext_encryption(string to_be_encrypted, string auth_key)
 //{
	
	 //data.msg_key = get_msg_key(to_be_encrypted, auth_key);
	 //string aes_key = get_aes_key(data.msg_key, auth_key);
	 //data.encrypted_data = AES256Encode(to_be_encrypted, (CryptoPP::byte*)aes_key.c_str());
